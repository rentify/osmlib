...
OSM database: OSMLib::Element::Node, OSMLib::Element::Way, and OSMLib::Element::Relation. They are all subclasses
of OSMLib::Element::Object.
...
There is also an OSMLib::Element::Member class for members of a relation:
...
There is also an OSMLib::OSMChange::Change object which can be used to store
...
See the OSMLib::API::Client class for details.
